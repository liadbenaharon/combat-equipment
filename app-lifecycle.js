(function(){
  ...
  function addReleaseStyles(){
    const theme=document.createElement('link');theme.rel='stylesheet';theme.href='./app-theme.css?v=6';document.head.appendChild(theme);
