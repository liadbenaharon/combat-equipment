const CACHE='combat-equipment-v10';
const ASSETS=['./','./index.html','./manifest.webmanifest','./icon.svg','./icon-192.png','./icon-512.png','./equipment-icons.js?v=6'];
function enhanceHtml(html){
 ...
 html=html.replace('</body>','<script src="./equipment-icons.js?v=6"></script></body>');
 return html;
}
