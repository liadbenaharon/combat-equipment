const CACHE='combat-equipment-v22';
const ASSETS=['./','./index.html','./manifest.webmanifest','./icon.svg','./icon-192.png','./icon-512.png','./equipment-icons.js?v=7','./quantity-shortcut.js?v=2','./history-collapse.js?v=1','./attendance.js?v=7'];
function enhanceHtml(html){
 ...
 html=html.replace('</body>','<script src="./equipment-icons.js?v=7"></script><script src="./quantity-shortcut.js?v=2"></script><script src="./history-collapse.js?v=1"></script><script src="./attendance.js?v=7"></script></body>');
 return html;
}
