importScripts('./app-config.js?v=11');
const CACHE=self.COMBAT_APP.cache;
const ASSETS=[
  './','./index.html','./manifest.webmanifest','./privacy.html','./delete-account.html',
  './icon-192.png','./icon-512.png','./app-theme.css?v=6','./app-config.js?v=11','./cloud-config.js?v=1','./cloud-bundle.js?v=2','./data-safety.js?v=3',
